                            ...
                            <div class="row mb-n7">
                                <div class="col-lg-4 col-sm-6 mb-7">
                                    <div class="footer-widget">
                                        ...
                                        <ul class="social social2 d-flex flex-wrap align-items-center mt-4">
    ...
    <!-- <script src="<?= $assets ?>/themes/benito/js/vendor/vendor.min.js"></script>
<script src="<?= $assets ?>/themes/benito/js/plugins/plugins.min.js"></script>
<script src="<?= $assets ?>/themes/benito/js/ajax-contact.js"></script>
<script src="<?= $assets ?>/themes/benito/js/main.js"></script> -->
    ...
    <script src="<?= $assets ?>/themes/benito/js/plugins/plugins.min.js"></script>
    <script src="<?= $assets ?>/themes/benito/js/ajax-contact.js"></script>
    <script src="<?= $assets ?>/themes/benito/js/main.min.js"></script>
